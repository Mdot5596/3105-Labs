...
void SceneBasic_Uniform::initScene()
{
    ...
    prog.setUniform("Material.Ka", glm::vec3(0.1f, 0.1f, 0.1f)); // Low ambient reflectivity
    prog.setUniform("Material.Kd", glm::vec3(1.0f, 0.5f, 0.3f)); // Orange diffuse color
    prog.setUniform("Material.Ks", glm::vec3(1.0f, 1.0f, 1.0f)); // White specular highlights
    prog.setUniform("Material.Shininess", 32.0f); // Higher = sharper highlights
